...
public class MapScheduler extends Scheduler {
    ...
    public static MapSchedulerBuilder create1(DataSource dataSource, Task<?>... knownTasks) {
        return create1(dataSource, Arrays.asList(knownTasks));
    }

    public static MapSchedulerBuilder create1(DataSource dataSource, List<Task<?>> knownTasks) {
        return new MapSchedulerBuilder(dataSource, knownTasks);
    }
